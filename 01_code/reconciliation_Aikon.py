...
def vhs_to_yolo(url_manifest: str, output_dir: Path) -> None:
    ...
    def iii_annotations_to_yolo(img_dict: dict, url_annotations: str, output_dir: Path) -> None:
...
vhs_to_yolo("https://vhs.huma-num.fr/vhs/iiif/wit2423_img2550/manifest.json", output_dir)
